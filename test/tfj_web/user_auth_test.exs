defmodule TfjWeb.UserAuthTest do
  use TfjWeb.ConnCase

  alias Tfj.Accounts
  alias Tfj.Accounts.Scope
  alias TfjWeb.UserAuth

  import Tfj.AccountsFixtures

  @remember_me_cookie "_tfj_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, TfjWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
